...
func Start(address string) {
	...
	projectGroup := router.Group("/api/project")
	{
		...
		projectGroup.POST("/copy", ProjectCopy)
		...
		projectGroup.GET("/get-img", ProjectGetImg)
	...
	graphGroup := router.Group("/api/graph")
	{
		...
		graphGroup.POST("/modify/img", GraphModifyImg)
		graphGroup.GET("/get-img", GraphGetImg)
	...
	prototypeGroup := router.Group("/api/prototype")
	{
		...
		prototypeGroup.POST("/modify/img", PrototypeModifyImg)
		prototypeGroup.GET("/get-img", PrototypeGetImg)
